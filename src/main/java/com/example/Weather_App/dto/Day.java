...
public class Day{
    ...
    public double uv;
    public double avgwetbulb_c;
    public double avgwetbulb_f;
    public double maxwetbulb_c;
    public double maxwetbulb_f;

    public Day(double maxtemp_c, double maxtemp_f, double mintemp_c, double mintemp_f, double avgtemp_c, double avgtemp_f, double maxwind_mph, double maxwind_kph, double totalprecip_mm, double totalprecip_in, double totalsnow_cm, double avgvis_km, double avgvis_miles, int avghumidity, int daily_will_it_rain, int daily_chance_of_rain, int daily_will_it_snow, int daily_chance_of_snow, Condition condition, double uv, double avgwetbulb_c, double avgwetbulb_f, double maxwetbulb_c, double maxwetbulb_f) {
        ...
        this.uv = uv;
        this.avgwetbulb_c = avgwetbulb_c;
        this.avgwetbulb_f = avgwetbulb_f;
        this.maxwetbulb_c = maxwetbulb_c;
        this.maxwetbulb_f = maxwetbulb_f;
    }
    ...
    public double getAvgwetbulb_c() {
        return avgwetbulb_c;
    }

    public void setAvgwetbulb_c(double avgwetbulb_c) {
        this.avgwetbulb_c = avgwetbulb_c;
    }

    public double getAvgwetbulb_f() {
        return avgwetbulb_f;
    }

    public void setAvgwetbulb_f(double avgwetbulb_f) {
        this.avgwetbulb_f = avgwetbulb_f;
    }

    public double getMaxwetbulb_c() {
        return maxwetbulb_c;
    }

    public void setMaxwetbulb_c(double maxwetbulb_c) {
        this.maxwetbulb_c = maxwetbulb_c;
    }

    public double getMaxwetbulb_f() {
        return maxwetbulb_f;
    }

    public void setMaxwetbulb_f(double maxwetbulb_f) {
        this.maxwetbulb_f = maxwetbulb_f;
    }
}